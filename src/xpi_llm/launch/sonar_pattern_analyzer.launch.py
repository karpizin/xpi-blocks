...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            package='xpi_llm',
            executable='sonar_pattern_analyzer_node',
            name='sonar_pattern_analyzer',
            parameters=[{
